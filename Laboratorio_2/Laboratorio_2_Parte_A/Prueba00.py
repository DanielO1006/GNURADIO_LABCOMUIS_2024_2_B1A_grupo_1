...
# Author: Daniel_Orduz_David_Astro
...
class Prueba00(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Prueba00")
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('C:\\Users\\dastr\\OneDrive\\Documents\\UIS\\Comunicaciones_I\\Lab_Comunicaciones\\Laboratorio_2\\Parte_A\\algomegustadeti_WY.wav', True)
