...
class Prueba00(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._GTX_range = qtgui.Range(0, 30, 500e-3, 5, 200)
        self._GTX_win = qtgui.RangeWidget(self._GTX_range, self.set_GTX, "Ganancia del Transistor", "counter_slider", float, QtCore.Qt.Horizontal)
